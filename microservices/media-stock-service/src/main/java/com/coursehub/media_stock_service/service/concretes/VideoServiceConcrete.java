...
import com.coursehub.media_stock_service.exception.*;
...
@Slf4j
public class VideoServiceConcrete implements VideoService {
    ...
    private void validateCourseOwner(String courseId) {
        Boolean isUserCourseOwner = courseServiceClient.isUserOwnerOfCourse(courseId).getBody();
    ...
    private void validateHasAccessToStream(String courseId, String userId) {
        Boolean isOwner = courseServiceClient.isUserOwnerOfCourse(courseId).getBody();
