...
import static com.coursehub.commons.security.constants.JwtConstants.MEDIA_STOCK_SERVICE_APP_NAME;
...
public class FeignConfig {
    ...
    public RequestInterceptor requestInterceptor() {
        return template -> {
            ...
            String internalToken = jwtServiceInternalToken.generateInternalToken(MEDIA_STOCK_SERVICE_APP_NAME);
