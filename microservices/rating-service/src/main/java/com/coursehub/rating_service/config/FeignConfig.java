...
import static com.coursehub.commons.security.constants.JwtConstants.RATING_SERVICE_APP_NAME;
...
public class FeignConfig {
    ...
    public RequestInterceptor requestInterceptor() {
        return template -> {
            ...
            String internalToken = jwtServiceInternalToken.generateInternalToken(RATING_SERVICE_APP_NAME);
