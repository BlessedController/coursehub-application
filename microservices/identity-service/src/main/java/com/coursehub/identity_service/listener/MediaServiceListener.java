...
import com.coursehub.commons.kafka.events.AddProfilePictureToUserEvent;
...
import static com.coursehub.commons.kafka.topics.PhotoTopics.ADD_USER_PROFILE_PHOTO_TOPIC;
...
public class MediaServiceListener {
    ...
    @KafkaListener(
            topics = ADD_USER_PROFILE_PHOTO_TOPIC,
            groupId = "identity-service-group",
            containerFactory = "kafkaAddProfilePhotoEventListenerContainerFactory"
    )
    public void listenAddUserProfilePhotoEvent(AddProfilePictureToUserEvent event) {
