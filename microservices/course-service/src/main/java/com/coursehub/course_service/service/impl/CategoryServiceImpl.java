...
import static com.coursehub.course_service.mapper.CategoryMapper.toCategoryResponse;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Page<CategoryResponse> getAllActiveCategories(Pageable pageable) {
        ...
        Page<CategoryResponse> responseList = categories.map(CategoryMapper::toCategoryResponse);
