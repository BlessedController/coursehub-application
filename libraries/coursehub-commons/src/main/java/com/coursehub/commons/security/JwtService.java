...
public class JwtService {
    ...
    public String buildToken(UserPrincipal principal, long expiration) {
        ...
        claims.put(CLAIM_ROLE, principal.getRole());
    ...
    public UserPrincipal verifyAccessToken(HttpServletRequest request) {
        ...
        try {
            ...
            //give attention to role because spring security can add ROLE_ prefix or something
            UserRole role = claims.getBody().get(CLAIM_ROLE, UserRole.class);
