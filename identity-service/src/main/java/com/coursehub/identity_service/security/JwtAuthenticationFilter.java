...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (request.getRequestURI().startsWith("/v1/user/login") ||
                request.getRequestURI().startsWith("/v1/user/register") ||
                request.getRequestURI().startsWith("/v1/user/refresh") ||
                request.getRequestURI().startsWith("/v1/user/activate")
        ) {
